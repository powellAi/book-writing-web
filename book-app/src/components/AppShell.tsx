...
export default function AppShell({ bookId, onBackToShelf }: AppShellProps) {
  ...
  // Actually reorders a chapter's position (used by the long-press drag
  // interaction, not by the up/down navigation controls).
      ...
      <div className="app-main">
        ...
        <main className="app-workspace">
          {!activeChapter ? (
            ...
            <div className="workspace-empty">
              <p>
                The writing editor for <strong>{activeChapter.title}</strong> is the next
